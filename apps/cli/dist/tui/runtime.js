...
import { ChildOutputFilter, isTuiControlOutput, scrollRegionSequence } from "./output-filter.js";
...
class ActiveTuiRuntime {
    ...
    redrawTimer = null;
    redrawInterval = null;
    outputFilter = new ChildOutputFilter();
    options;
    ptyAdapter;
    stdin;
    stdout;
...
function shouldRedrawFooterImmediately(data) {
