...
('role-super-admin', 'super_admin', UTC_TIMESTAMP(), UTC_TIMESTAMP()),
('role-user', 'user', UTC_TIMESTAMP(), UTC_TIMESTAMP());
...
SET a.role_id = 'role-user', a.updated_at = UTC_TIMESTAMP()
...
DELETE FROM field_enum WHERE field = 'account_role' AND value NOT IN ('super_admin', 'user');

-- +goose Down
DROP TABLE IF EXISTS field_enum;
DROP TABLE IF EXISTS config;
DROP TABLE IF EXISTS group_scopes;
DROP TABLE IF EXISTS account_groups;
DROP TABLE IF EXISTS `groups`;
DROP TABLE IF EXISTS node_sla_minutes;
DROP TABLE IF EXISTS node_health_history;
DROP TABLE IF EXISTS id_sequences;
DROP TABLE IF EXISTS network_audit_sessions;
DROP TABLE IF EXISTS business_audit_events;
DROP TABLE IF EXISTS chain_probe_results;
DROP TABLE IF EXISTS node_transports;
DROP TABLE IF EXISTS node_onboarding_tasks;
DROP TABLE IF EXISTS tenant_access_paths;
DROP TABLE IF EXISTS tenant_scopes;
DROP TABLE IF EXISTS tenant_route_rules;
DROP TABLE IF EXISTS tenant_chains;
DROP TABLE IF EXISTS tenant_node_links;
DROP TABLE IF EXISTS tenant_nodes;
DROP TABLE IF EXISTS node_access_paths;
DROP TABLE IF EXISTS node_trust_materials;
DROP TABLE IF EXISTS node_api_tokens;
DROP TABLE IF EXISTS node_health_snapshots;
DROP TABLE IF EXISTS certificates;
DROP TABLE IF EXISTS bootstrap_tokens;
DROP TABLE IF EXISTS node_policy_assignments;
