...
export type PathMode = 'forward' | 'reverse' | 'direct' | 'tcp' | 'udp';
export type AccessProtocol = 'http' | 'https' | 'connect' | 'tcp' | 'udp' | 'quic';
export type AccessServiceType = 'http_forward_proxy' | 'reverse_proxy' | 'tcp_access' | 'udp_access' | 'direct_quic';
export type TLSMode = '' | 'passthrough' | 'terminate' | 'direct_verify';
export type AccessAuthMode = 'proxy_token';
...
export type TransportType = 'public_http' | 'public_https' | 'reverse_ws_parent' | 'direct_udp_candidate' | 'direct_quic' | 'direct_relay' | 'child_ws' | 'reverse_ws';
