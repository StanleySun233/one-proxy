const routes = [
  { path: "/console/overview", label: "Overview" },
  { path: "/console/health", label: "Health" },
  { path: "/console/audit", label: "Audit" },
  { path: "/console/policy", label: "Policy" },
  { path: "/console/diagnostics", label: "Diagnostics" }
];
...
async function render() {
  const path = location.pathname === "/console" ? "/console/overview" : location.pathname;
  ...
  if (!session.authenticated || path === "/console/login") {
    renderLogin();
    return;
  }
  ...
  const renderers = {
    "/console/overview": renderOverview,
    "/console/health": renderHealth,
    "/console/audit": renderAudit,
    "/console/policy": renderPolicy,
    "/console/diagnostics": renderDiagnostics
  };
